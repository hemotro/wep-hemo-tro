...
- [ ] إنشاء صفحة إدارة الأقسام مع اختيار المسلسلات
- [ ] إضافة نظام رفع الصور من الجهاز إلى S3
- [ ] إنشاء صفحة تعديل المسلسلات (الاسم، الوصف، الصور)
- [ ] إنشاء صفحة إدارة القنوات (إضافة، تعديل، حذف)
- [ ] اختبار جميع الميزات والتأكد من أنها تعمل بشكل صحيح
