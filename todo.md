...
- [ ] إضافة جدول Likes في قاعدة البيانات
- [ ] إضافة endpoints للإعجابات (add/remove like)
- [ ] تحديث الصفحة الرئيسية بـ 3 أقسام ديناميكية
  - [ ] السلايدر: آخر 4 مسلسلات
  - [ ] المسلسلات الجديدة: آخر 6 مسلسلات
  - [ ] الأعلى تقييماً: أفضل 5 مسلسلات حسب الإعجابات
- [ ] إضافة زر الإعجاب في صفحة تفاصيل المسلسل
- [ ] إزالة الأقسام الفارغة من الصفحة الرئيسية
- [ ] إزالة السلايدر القديم
